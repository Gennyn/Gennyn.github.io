...
format:
  revealjs:
    theme: serif
    slide-number: true
    footer: "Data Analysis for Decision-Making (SS 2026)"
    embed-resources: true
editor: visual
---

Email: [nnakwuzie.nwanneka\@stud.hs-fresenius.de](mailto:nnakwuzie.nwanneka@stud.hs-fresenius.de)
...
![](dashboard.png){fig-align="center"}
...
**Business question:** How can we segment our customers by age, income, and spending behaviour?
...
**Step 2 — Upload data in Radiant:** Data → Manage → Load data → select `customers_data.csv` → click Load

**Step 3 — Verify the dataset:** Data → View → confirm these columns are present:
...
Multivariate → Cluster → select variables: **Age, AnnualIncome, SpendingScore** → Method: **K-means** → k = **3** → click **Estimate / Run**
...
*Business meaning:* Strong purchasing power, already highly engaged. Priority for loyalty programmes.
:::
...
*Business meaning:* Price-sensitive group. Respond well to discounts and value-for-money offers.
:::
...
*Business meaning:* Ability to spend more but not yet engaged. Target with personalised campaigns.
:::
::::::
...
> Which R package would you use **first** if you wanted to create an interactive business analytics dashboard, Radiant or Shiny and why?
